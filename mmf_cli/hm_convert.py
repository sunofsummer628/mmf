...
class HMConverter:
    ...
    def convert(self):
        ...
        # /root/.cache/torch/mmf/data/datasets/hateful_memes/defaults
        base_path = os.path.join(data_dir, "datasets", "hateful_memes", "defaults")

        # /root/.cache/torch/mmf/data/datasets/hateful_memes/defaults/images
        ...
        # /root/.cache/torch/mmf/data/datasets/hateful_memes/defaults/annotations
        ...
        for annotation in annotations:
            print(f"Moving file: {annotation}")
            # /root/.cache/torch/mmf/data/datasets/hateful_memes/defaults/images/data/annotation_file (copied L134)
            src = os.path.join(images_path, "data", annotation)
            # /root/.cache/torch/mmf/data/datasets/hateful_memes/defaults/annotations/annotation_file
